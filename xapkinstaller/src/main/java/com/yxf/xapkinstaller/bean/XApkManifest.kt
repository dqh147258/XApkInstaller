...
internal data class XApkManifest(
    ...
    companion object {
        ...
        fun fromJson(reader: InputStreamReader): XApkManifest {
            val gson = GsonBuilder().excludeFieldsWithoutExposeAnnotation().create()
            return gson.fromJson(reader, XApkManifest::class.java)
        }

        fun fromJson(json: String): XApkManifest {
            val gson = GsonBuilder().excludeFieldsWithoutExposeAnnotation().create()
            return gson.fromJson<XApkManifest>(json, XApkManifest::class.java)
